...
export default function CerrarPeriodoPage() {
    ...
    const esAdmin = user?.role?.toLowerCase() === 'admin' || user?.role?.toLocaleLowerCase() === 'jefe';
    ...
    const cargarEmpleadosArea = async () => {
        const empleadosArea = empleados.filter((e) => e.area?.nombre === areaId);
        setEmpleadosSeleccionados(empleadosArea.map((e) => e.id));
    };
        ...
        return (
            <Layout>
                <div className="p-8 text-center">
                    ...
                    <p className="text-gray-600">Solo administradores y jefes pueden cerrar periodos.</p>
                </div>
            </Layout>
        );
    }
                                    ...
                                    <div className="space-y-2">
                                        {resultado.detalles.map((detalle, idx) => (
                                            ...
                                            >
                                                ...
                                                <button
                                                    onClick={() => navigate(`/evaluaciones/${detalle.evaluacionId}`)}
                        ...
                        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                            ...
                            <div className="grid grid-cols-3 gap-4 mb-6">
                                ...
                                >
                                    ...
                                    <p className="text-sm text-gray-600 mt-1">{areas.length} áreas</p>
                                </button>
                        ...
                        <div className="flex items-center justify-between bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                            <div>
                                <p className="text-sm text-gray-600">
                                    ...
                                    {modoSeleccion === 'area' && areaId && `Se evaluarán empleados del área: ${areaId}`}
                                    {modoSeleccion === 'especificos' &&
